...
def _threshold_metrics(
    ...
    *,
    ...
    hard_bot_recall = true_positives / max(positive_count, 1) if positive_count > 0 else 0.0
    hard_fpr = false_positives / max(negative_count, 1) if negative_count > 0 else 0.0
